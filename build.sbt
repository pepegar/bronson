inThisBuild(List(
  ...
  homepage := Some(url("https://github.com/pepegar/bronson")),
...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/pepegar/bronson"),
        "git@github.com:pepegar/bronson.git"
      )
    ),
    homepage := Some(url("https://github.com/pepegar/bronson")),
  )
...
lazy val micrositesSettings = Seq(
    micrositeName := "bronson",
    micrositeDescription := "super cool project",
    micrositeBaseUrl := "bronson",
    micrositeGithubOwner := "pepegar",
    micrositeGithubRepo := "bronson",
